# [+] Author BrayennXD and Recode By DemonLord27
...
try:
	...
	print(' [+] Koneksi Internet Anda Tidak Terdeteksi Silahkan Cek Kuota Anda Ya Salam Dari DemonLord27');exit()
...
def menu(my_name,my_id):
	...
	if _____brayennn___xd____ in ['1','01']:
		...
		file_cp()
	elif _____brayennn___xd____ in ['0']:
		result()
		...
		spam_sms()
	elif _____brayennn___xd____ in ['dump id','dump','Dump ID','Dump Id','DUMP ID']:
		dumpid()
	elif _____brayennn___xd____ in ['X','logout','x']:
...
[bold white][[bold cyan]03[bold white]] [bold white]Pake Pw Manual? [[bold red]Not Recommended[bold white]]''',style='bold white',title='[bold green]Setting Password',padding=(0,8),width=90))
	...
	cetak(panel(f'      [bold white]Apakah Anda Ingin Menampilkan Aplikasi Yang Terkait Di Dalam Akun ? Y/N',width=90,title=f"[bold green]Setting Cek Apk",style=f"bold white"))
	...
	cetak(panel(f'      [bold white]Apakah Anda Ingin Menampilkan Opsi Checkpoint Di Dalam Akun ? Y/N',width=90,title=f"[bold green]Cek Opsi",style=f"bold white"))
	_brayen_ = input(' [+] Pilih : ')
	if _brayen_ in ['']:
		print(' [+] Pilih Yang Bener  ')
		exit()
	...
	cetak(panel(f'[bold white]Mo Pake UA manual ga bang? Y/N',width=90,title=f"[bold green]Setting User-Agent",style=f"bold white"))
